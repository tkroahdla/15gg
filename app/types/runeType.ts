export const RUNETYPE: any = {
  ...
  8143: {
    ...
    longDesc:
      "돌진, 도약, 점멸, 순간이동을 사용하거나 은신에서 빠져나온 뒤 적 챔피언에게 피해를 주면 5초 동안 9의 물리 관통력과 7의 마법 관통력을 얻습니다.<br><br>재사용 대기시간: 4초",
  },
  8136: {
    id: 8136,
    key: "ZombieWard",
  ...
  8008: {
    ...
    longDesc:
      "적 챔피언을 기본 공격하면 6초 동안 공격 속도가 [60%~90%] (근접) 또는 [30%~54%] (원거리) 상승합니다. 이 효과는 6회까지 중첩됩니다.<br><br>최대로 중첩되면 공격 속도가 2.5를 초과할 수 있으며 공격 사거리가 50 상승합니다.",
  },
  8021: {
    id: 8021,
    key: "FleetFootwork",
  ...
  9101: {
    ...
    longDesc:
      "자신에 대한 체력 회복 초과분이 레벨에 따라 20~300의 피해를 흡수하는 보호막으로 전환됩니다.<br><br>보호막 전환율은 자신 또는 아군으로부터 받는 체력 회복 초과분의 20~100%입니다.",
  },
  9111: {
    id: 9111,
    key: "Triumph",
  ...
  9105: {
    ...
    longDesc:
      "강인함이 5% 증가하며 <i>전설</i> 중첩당 1.5%의 강인함이 추가로 증가합니다. (<statGood>최대 전설 중첩 횟수: 10</statGood>)<br><br>챔피언 처치 관여, 에픽 몬스터 처치 관여, 대형 몬스터 처치, 미니언 처치 시마다 <i>전설</i> 중첩을 얻습니다.",
  },
  9103: {
    id: 9103,
    key: "LegendBloodline",
  ...
  8242: {
    ...
    longDesc:
      "강인함이 5%, 둔화 저항이 5% 증가합니다. 잃은 체력에 비례하여 강인함은 20%, 둔화 저항은 20% 추가로 증가합니다. 체력이 30%일 때 최대로 증가합니다. ",
  },
  8200: {
    id: 8200,
    key: "Sorcery",
  ...
  8230: {
    ...
    longDesc:
      "4초 안에 한 챔피언에게 기본 공격 또는 <b>개별</b> 스킬 3회를 적중시키면 레벨에 따라 <speed>15~40%의 이동 속도</speed>와 75%의 둔화 저항 효과를 얻습니다. <hr>근접 챔피언의 경우 <speed>이동 속도가 30~60%</speed>까지 증가합니다.<hr>지속시간: 3초<br>재사용 대기시간: 30초~10초",
  },
  8224: {
    id: 8224,
    key: "NullifyingOrb",
  ...
  8369: {
    ...
    name: "선제공격",
    shortDesc:
      "적 챔피언과 전투 개시 시 3초 동안 9%의 추가 피해 및 입힌 피해에 따라 골드 획득",
    longDesc:
      "적 챔피언과 전투 시작 후 0.25초 내에 스킬이나 기본 공격으로 해당 적 챔피언에게 피해를 입히면 5골드를 획득하고 3초 동안 <b>선제공격</b> 효과가 발동됩니다. 효과 발동 시 적 챔피언에게 <truedamage>9%</truedamage>의 추가 <truedamage>피해</truedamage>를 입힙니다. 또한 입힌 추가 피해의 <gold>100%(원거리 챔피언은 70%)</gold>에 해당하는 <gold>골드</gold>를 획득합니다.<br><br>재사용 대기시간: <scaleLevel>25~15</scaleLevel>초",
  },
  8306: {
    id: 8306,
  ...
  8352: {
    ...
    longDesc:
      "물약이나 비스킷을 사용하면 체력이나 마나 회복량의 30%를 즉시 회복합니다. 또한 물약이나 비스킷의 효과가 지속되는 동안 <speed>이동 속도가 2%</speed> 증가합니다.<br><br>",
  },
};
